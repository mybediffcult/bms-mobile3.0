            ...
            return (
                <li key={"terminal_" + index}>
                    ...
                    <div className="middle">
                        <p className="name">{terminal.administration_name}</p>
                        <a className="btn-view" href={"#/terminal/" + terminal.id + "/program/list"}>查看节目单</a>
                    </div>
                    <div className="right">
                        <span className={"light " + (terminal.online == "1" ? "on" : "off")}></span>
                        <span className="online-status">{terminal.online == "1" ? "在线" : "离线"}</span>
                    </div>
                </li>
            );
        });
